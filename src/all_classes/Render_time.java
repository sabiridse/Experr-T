...
public class Render_time extends JLabel implements TableCellRenderer  
{
          ...
          Object value, boolean isSelected, boolean hasFocus, int row, int column)
  {
		...
		long time_st = 0;
		    ...
		    long defoult = curTime - (long) 978296400000.0 - (long) 3660000;
			...
			if (isSelected == false){
						switch (column) {
								...
								case 3:try {if(res == defoult){setBackground(new Color(0, 153, 255));setOpaque(true); break;};
											if(res >  interval_pay){setBackground(new Color(255, 153, 153));setOpaque(true); break;}} catch (Exception e) {}
